...
* Be descriptive and imply type - E.g. for booleans, you can prefix with **_is__ or _has__** to make it clear it is a condition. You can also use part of speech to imply types, like verbs for functions and nouns for variables.

* Be consistent but clearly differentiate - E.g. **_age_list_** and **_age_** is easier to differentiate than ages and age.
...
A full Udacity course on this topic can be found here[Writing READMEs](https://classroom.udacity.com/courses/ud777).
